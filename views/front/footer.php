        ...
        <div class="footer-bottom1-inner">
            ...
            <div class="cards-wrapper cards-wrapper-lines">
                ...
                <div class="card-links">
                    <ul>
                    <li><a href="#"><img src="<?=Controller::asset('front/img/cards/card-1.png');?>" alt="card-img"></a></li>
                    <li><a href="#"><img src="<?=Controller::asset('front/img/cards/card-2.png');?>" alt="card-img"></a></li>
                    <li><a href="#"><img src="<?=Controller::asset('front/img/cards/card-3.png');?>" alt="card-img"></a></li>
                    <li><a href="#"><img src="<?=Controller::asset('front/img/cards/card-4.png');?>" alt="card-img"></a></li>
                    </ul>
                </div>
            </div>
            <div class="apps-download">
                ...
                <div class="app-links">
                    <ul>
                    <li><a href="#"><img src="<?=Controller::asset('front/img/apps/app-store-1.png');?>" alt="app-img"></a></li>
                    <li><a href="#"><img src="<?=Controller::asset('front/img/apps/app-store-2.png');?>" alt="app-img"></a></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="copyright-area copyright1-area">
        ...
        <div class="copyright1-inner">
            <div class="copyright-text copyright1-text">
                Copyright &copy; <?=date('Y');?> <a href="https://themeforest.net/user/bdevs/portfolio">BDevs</a>. All Rights Reserved
            </div>
